...
function detectQueryLanguage(text) {
  ...
  if (isEnglish && t.trim().length >= 2) return "en";
...
function getSelectedModel() {
  ...
  if (!saved || saved.includes("qwen") || saved.includes("gpt-oss")) {
...
⚠️ نیزہ بازی یا دوڑ توں فوراً بعد دانا نہ پاؤ، 45 منٹ بعد واک توں بعد کھلاؤ۔`;
    ...
    // 7. Skin Itching / Mange / Dandruff / Fungus / خارش، چمڑی دی خارش، جوئیں، فنگس
    if (q.includes("خارش") || q.includes("کھارش") || q.includes("کھجلی") || q.includes("چمڑی") || q.includes("کھل") || q.includes("جوئیں") || q.includes("چیچڑ") || q.includes("فنگس") || q.includes("الرجی") || q.includes("دانے") || q.includes("جھڑ") || q.includes("itch") || q.includes("mange")) {
      const reply = `**🐎 گھوڑے دی خارش، چمڑی دی الرجی، جوئیاں تے فنگس دا شاہی دیسی و میڈیکل علاج**
*(فہیم غیاث محمود - غیاث فارم ہاؤس دی مستند فیلڈ رہنمائی)*

ویر جی! گھوڑے نوں خارش پے جاوے، او کندھاں نال کھل رگڑ کے وال جھاڑ لووے یا دم تے گردن تے کھجلی کرے، تاں اے 4 کم فوری کرو، خارش جڑ توں مک جائے گی:

---

### **🌿 1. شاہی دیسی تارا میرا تیل (کھل دی مالش):**
• **خالص تارا میرا دا تیل:** 250 ملی لیٹر (خارش تے جوئیاں دا سب توں وڈا دیسی توڑ)
• **پسی ہوئی گندھک آملہ سار (Sulphur Powder):** 50 گرام
• **پسی ہوئی کافور دیاں گولیاں (Camphor):** 15 گرام
• **سفید پھٹکری پاؤڈر:** 15 گرام
• **طریقہ:** تارا میرا دے تیل چ گندھک، کافور تے پھٹکری رلا کے نیم گرم کرو۔ گردن، والاں دی جڑاں، پونچھ تے پٹھے جتھے گھوڑا خارش کردا اے، سویرے دھوپے اچھی طرح انگلاں نال مالش کرو۔ 3 توں 4 دناں چ خارش تے جوئیاں دا مکمل صفایا ہو جائے گا تے نویں ریشمی وال نکلن گے۔

---

### **🧼 2. نمب دے پتیاں دا کاڑھا (اینٹی سیپٹک شنان):**
• 1 کلو دیسی نمب دے پتے 10 لیٹر پانی چ ابال لوو۔ ہلکا نیم گرم کر کے ایندے نال گھوڑے دی کھل دھوؤ۔ اے چمڑی دی فنگس تے بیکٹیریا نوں جڑ توں صاف کر دیندا اے۔

---

### **💉 3. کیڑیاں دا میڈیکل صفایا (Ivermectin Protocol):**
• خارش دا 70% سبب چمڑی دے اندر مائٹس (Mange) ہندے نے۔ ویٹرنری میڈیکل توں **Ivermectin Paste** لیا کے خالی پیٹ گھوڑے دی جیبھ تے لاؤ یا ڈاکٹر توں **Ivermectin 1% انجیکشن (1ml فی 50 کلو وزن)** لوواؤ۔ 14 دن بعد دوبارہ لازمی دوو تاں جے انڈے وی مک جان۔

---

### **🌾 4. خوراک دی سنبھال:**
• گرمی دانے تے کھجلی ویلے گُڑ تے بوہتا سرسوں دا تیل وقتی طور تے گھٹاؤ۔ ٹھنڈ لئی پاݨی چ 50 گرام سونف دا جوشاندہ تے تخم ملنگا گھول کے پلاؤ تاں جے جگر دی گرمی نکلے۔`;
      conversationHistory.push({ role: "assistant", content: reply });
      return reply;
    }

    // 8. Cough & Cold / کھنگ، نزلہ، بلغم، چھاتی
    if (q.includes("کھنگ") || q.includes("کھانسی") || q.includes("نزلہ") || q.includes("زکام") || q.includes("بلغم") || q.includes("سانس") || q.includes("نمونیا") || q.includes("چھاتی")) {
      const reply = `**🐎 گھوڑے دی کھنگ (کھانسی)، نزلہ، بلغم تے چھاتی دی خرابی دا دیسی علاج**
*(غیاث فارم ہاؤس نیزہ بازی کیئر)*

ویر جی! گھوڑے نوں کھنگ پے جاوے یا نتھنیاں چوں ریشہ وگے تاں فوری اے شاہی نسخہ بناؤ:

---

### **🌿 1. کالی مرچ، سنڈھ تے پرانے گُڑ دا شاہی حلوہ:**
• **پرانا کالا گُڑ:** 150 گرام
• **پسی کالی مرچ:** 15 گرام
• **پسی ہوئی سنڈھ (سُکی ادرک):** 15 گرام
• **اجوائن دیسی:** 15 گرام
• **دیسی گھیو:** 50 گرام
• **طریقہ:** دیسی گھی چ سنڈھ، کالی مرچ تے اجوائن ہلکی بھن لوو، پھر گڑ رلا کے نیم گرم وٹیاں (پیڑے) بنا کے سویرے شام گھوڑے نوں کھواؤ۔ سینے دا ریشہ پگھل کے نکل جائے گا۔

---

### **💨 2. یوکلپٹس تے وکس دی بھاپ (Steam):**
• ابلدے پانی دی بالٹی چ وکس یا یوکلپٹس دا تیل پا کے توبرے دے ذریعے گھوڑے نوں 10 منٹ بھاپ دوو، نتھنیاں کھل جان گیاں۔
• 💊 جے بخار نال ہووے تاں ڈاکٹر توں اینٹی بائیوٹک کورس شروع کراؤ۔`;
      conversationHistory.push({ role: "assistant", content: reply });
      return reply;
    }

    // 9. Fever & Heat / بخار، تپ، جسم گرم، سستی
    if (q.includes("بخار") || q.includes("تپ") || q.includes("جسم گرم") || q.includes("سستی") || q.includes("ڈھلا")) {
      const reply = `**🌡️ گھوڑے دا بخار (تپ) تے جسمانی سستی دا ہنگامی علاج**
*(غیاث فارم ہاؤس ویٹرنری پروٹوکول)*

ویر جی! گھوڑے دا نارمل درجہ حرارت 99.5°F توں 101.5°F ہندا اے۔ جے 102°F توں اتانہہ ہووے تاں بخار اے:

---

### **🧊 1. فوری ٹھنڈیاں پٹیاں:**
• گھوڑے دے سر، گردن تے لتاں تے تازہ پانی پاؤ یا ٹھنڈے پانی چ بھجے تولیے رکھو۔ پیٹ تے برف ہرگز نہ پاؤ۔
• چھاں تے ہوادار تھاں تے بنھو۔

---

### **💊 2. ویٹرنری بخار دا ٹیکہ:**
• فوری ویٹرنری ڈاکٹر نوں بلا کے **Ketoprofen (Ketofen)** یا **Flunixin Meglumine (Banamine)** دا انجیکشن لوواؤ۔
• پینے دے پانی چ الیکٹرو فیول (Electro Fuel) یا دیسی نمک تے گلوکوز ملا کے دیو تاں کہ پانی دی کمی نہ ہووے۔`;
      conversationHistory.push({ role: "assistant", content: reply });
      return reply;
    }

    // 10. Wounds & Bleeding / کٹ، زخم، خون، پیپ
    if (q.includes("زخم") || q.includes("کٹ") || q.includes("خون") || q.includes("پیپ") || q.includes("پھوڑا") || q.includes("ناسور")) {
      const reply = `**🩹 گھوڑے دے زخم، کٹ تے خون دا فوری دیسی و میڈیکل علاج**
*(غیاث فارم ہاؤس نیزہ بازی کیئر)*

ویر جی! نیزہ بازی یا مشق چ کٹ لگ جاوے یا زخم چ پیپ پے جاوے:

---

### **🩸 1. خون بند کرن دا طریقہ:**
• صاف تولیہ یا روئی زخم تے رکھ کے 10 منٹ ہتھ نال سخت دباؤ (Direct Pressure) رکھو۔
• ٹٹنس دا ٹیکہ (**Tetanus Antitoxin TAT 1500-3000 IU**) فوری لوواؤ جے گھوڑا ویکسینیٹڈ نئیں اے۔

---

### **🌿 2. دیسی جراثیم کش مرحم:**
• پسی ہوئی بریاں پھٹکری (20 گرام) + کافور (10 گرام) + خالص نیم دا تیل یا سرسوں دا تیل (100 ملی لیٹر) رلا کے مرحم بناؤ۔
• زخم نوں پائیوڈین (Pyodine) نال دھو کے روزانہ اے مرحم لاؤ۔ مکھیاں توں بچاؤن لئی نیلا تھوتھا ہلکا جیا چھڑکو۔`;
      conversationHistory.push({ role: "assistant", content: reply });
      return reply;
    }

    // 11. General Punjabi Fallback (Smart Comprehensive)
    const generalReply = `**السلام علیکم ویر جی!**
**اسپِ شفا اے آئی ویٹرنری پورٹل (غیاث فارم ہاؤس - فہیم غیاث محمود)**

ویر جی! تہاڈے سوال دا جواب تیار اے:
گھوڑے دی صحت، خارش، کھنگ، بخار، پٹھیاں دے کھچاؤ، کھر پاتن، پیٹ چ ول (کولک)، یا شاہی دیسی ونڈے دے تمام مستند نسخے موجود نے۔

• **عام کچن اشیاء:** ہلدی، سرسوں دا تیل، تارا میرا، دیسی اجوائن، سونف، کالا نمک، لہسن تے السی۔
• **تہاڈے لئی خاص صلاح:** تسیں 🎤 مائیک تے بول کے پچھو (جیویں: "خارش دا علاج"، "موٹا کرن دا نسخہ"، "پٹھیاں دا لیپ") یا 📷 تصویر بھیجو، فوری مکمل رہنمائی ملے گی۔`;
...
⚠️ **اہم ویٹرنری ہدایت:** راشن کی مقدار یکدم نہ بڑھائیں بلکہ 7 سے 10 دنوں کے دوران آہستہ آہستہ خوراک میں اضافہ کریں تاکہ معدہ عادی ہو سکے۔`;
  ...
  // 2. Colic / پیٹ درد و قولنج
  if (q.includes("پیٹ") || q.includes("درد") || q.includes("گیس") || q.includes("قولنج") || q.includes("قبض") || q.includes("اپھارہ") || q.includes("گوبر") || q.includes("مروڑ")) {
...
• اگر 45 منٹ میں افاقہ نہ ہو تو فوری ویٹرنری ڈاکٹر سے درد کش انجیکشن (**Flunixin Meglumine / Banamine** یا **Buscopan**) لگوائیں۔`;
  ...
  if (q.includes("موچ") || q.includes("سوجن") || q.includes("چوٹ") || q.includes("پٹھے") || q.includes("جوڑ") || q.includes("کھچاؤ") || q.includes("چھ گیا") || q.includes("اکڑ")) {
...
• شدید کھچاؤ میں زبردستی واک نہ کرائیں، گھوڑے کو گرم چادر اوڑھائیں اور الیکٹرولائٹس پلائیں۔`;
  ...
  // 4. Skin Itching / Mange / Dandruff / Fungus / خارش، چمڑی کی خارش، جوئیں، فنگس، الرجی
  if (q.includes("خارش") || q.includes("کھارش") || q.includes("کھجلی") || q.includes("چمڑی") || q.includes("جلد") || q.includes("جوئیں") || q.includes("چیچڑ") || q.includes("فنگس") || q.includes("الرجی") || q.includes("دانے") || q.includes("جھڑ") || q.includes("itch") || q.includes("mange")) {
    const reply = `**🐎 گھوڑے کی شدید خارش، چمڑی کی الرجی، جوؤں اور فنگس کا اکسیر دیسی و میڈیکل علاج**
*(فہیم غیاث محمود - غیاث فارم ہاؤس کا آزمودہ اصطبل فارمولا)*

گھوڑوں میں خارش، کھجلی اور دیواروں سے جسم رگڑنے کی 3 بنیادی وجوہات ہوتی ہیں:
1. **چمڑی کے باریک طفیلیے و جوئیں (Mange Mites & Lice)** جو بالوں کی جڑوں میں کاٹتے ہیں اور گھوڑا بے چین ہو کر بال جھاڑ دیتا ہے۔
2. **فنگس و خشکی (Fungal Infection / Rain Rot)** جس سے گول دائروں میں بال اترتے ہیں اور جلد کھردری ہو جاتی ہے۔
3. **خون کی حدت و خوراک کی الرجی (Feed Allergy / Sweet Itch)** جو زیادہ گرم راشن یا مکھیوں کے کاٹنے سے پیدا ہوتی ہے۔

---

### **🌿 1. شاہی دیسی اکسیر تیل برائے خارش (بیرونی مالش):**
• **خالص تارا میرا کا تیل:** 250 ملی لیٹر (خارش، کھجلی اور جوئیں مارنے کا لاجواب دیسی تیل)
• **پسی ہوئی گندھک آملہ سار (Sulphur Powder):** 50 گرام (اینٹی فنگل و کیڑے مار)
• **پسی ہوئی کافور کی ٹکیاں (Camphor):** 15 گرام (سوزش اور جلن ختم کرنے کے لیے)
• **سفید پھٹکری پاؤڈر:** 15 گرام
• **طریقہ تیاری و استعمال:** 
  1. تارا میرا کے تیل میں گندھک، کافور اور پھٹکری اچھی طرح مکس کر کے دھوپ میں 2 گھنٹے رکھیں یا ہلکا نیم گرم کر لیں۔
  2. متاثرہ جگہوں (گردن کی مانگ، دم کی جڑوں، سینے اور پیٹ کے نیچے) جہاں گھوڑا خارش کر رہا ہو، بالوں کے مخالف رخ انگلیوں سے روزانہ ایک بار اچھی طرح مالش کریں۔
  3. 3 سے 4 دن کے اندر خارش کی جلن، جوئیں اور کھجلی جڑ سے ختم ہو جائے گی اور کھال نرم ہو کر نئے چمکدار بال نکلنا شروع ہو جائیں گے۔

---

### **🧼 2. نیم کے پتوں کا اینٹی سیپٹک شیمپو واش:**
• 1 کلو دیسی نیم کے پتے 10 لیٹر پانی میں جوش دیں یہاں تک کہ پانی گہرا سبز ہو جائے۔
• اس نیم گرم پانی میں 2 ڈھکن ڈیٹول یا پائیوڈین ملا کر ہفتے میں 2 بار گھوڑے کے جسم کو نلھائیں اور دھوپ میں خشک کریں۔ یہ ہر قسم کے بیکٹیریا اور فنگس کا خاتمہ کرتا ہے۔

---

### **💉 3. جدید ویٹرنری و میڈیکل علاج (کیڑوں کا اندرونی صفایا):**
• **آئیورمیکٹن پروٹوکول (Ivermectin):** چمڑی کے اندر چھپے باریک کیڑوں (Mange Mites) کے مکمل خاتمے کے لیے ویٹرنری اسٹور سے **Ivermectin Paste** لا کر صبح خالی پیٹ گھوڑے کی زبان پر لگائیں، یا ویٹرنری ڈاکٹر سے **Ivermectin 1% Injection (1ml فی 50 کلو وزن)** کھال کے نیچے لگوائیں۔
• 14 دن بعد یہ عمل ایک بار دہرائیں تاکہ نئے نکلنے والے انڈے بھی ختم ہو جائیں۔
• اگر چمڑی پر الرجی کے دانے اور سوجن زیادہ ہو تو ویٹرنری اینٹی الرجک انجیکشن (**Pheniramine Maleate / Avil**) لگوائیں۔

---

### **🌾 4. خوراک اور اصطبل میں ضروری احتیاط:**
• خارش اور الرجی کے دوران پرانا گڑ، زیادہ سرسوں کا تیل اور گرم ونڈا وقتی طور پر کم کریں۔
• جگر کی گرمی ختم کرنے کے لیے راشن میں **السی کا قوام (150 گرام)** اور پینے کے پانی میں **50 گرام سونف کا جوشاندہ اور تخم ملنگا** شامل کریں۔
• اصطبل کے کھرکھرے، برش اور زین کے پیڈ کو نیم کے گرم پانی اور ڈیٹول سے دھوئیں تاکہ خارش دوبارہ نہ پھیلے۔`;
    conversationHistory.push({ role: "assistant", content: reply });
    return reply;
  }

  // 5. Cough & Respiratory / کھانسی، نزلہ، بلغم، سانس
  if (q.includes("کھانسی") || q.includes("نزلہ") || q.includes("زکام") || q.includes("بلغم") || q.includes("سانس") || q.includes("نمونیا") || q.includes("ہیوز") || q.includes("چھاتی")) {
    const reply = `**🐎 گھوڑے کی کھانسی، نزلہ، بلغم اور سانس کی تنگی کا دیسی کاڑھا و حلوہ**
*(فہیم غیاث محمود - غیاث فارم ہاؤس کا مجرب نسخہ)*

گھوڑوں میں کھانسی عام طور پر دھول مٹی، الرجک ہیوز (Heaves) یا ٹھنڈ لگنے سے ہوتی ہے۔

---

### **🌿 1. کالی مرچ اور پرانے گڑ کا شاہی حلوہ:**
• **پرانا کالا گڑ:** 150 گرام
• **پسی ہوئی کالی مرچ:** 15 گرام
• **سونٹھ (خشک ادرک پاؤڈر):** 15 گرام
• **دیسی اجوائن:** 15 گرام
• **خالص دیسی گھی:** 50 گرام
• **طریقہ:** دیسی گھی میں مصالحہ جات ہلکے بھون لیں اور گڑ ملا کر نیم گرم پیڑے بنا کر صبح شام کھلائیں۔ یہ سینے کا بلغم اور جمی ہوئی رطوبت پگھلا کر نکال دیتا ہے۔

---

### **💨 2. بھاپ اور نیبولائزیشن:**
• ابلتے پانی کی بالٹی میں وکس یا یوکلپٹس کا تیل ڈال کر توبرے کے ذریعے 10 منٹ بھاپ دیں۔
• اگر الرجک کھانسی ہو تو ڈاکٹر سلطان مسعود کے اصول کے مطابق نیبولائزر سے میڈیسن دیں تاکہ پھیپھڑوں کی نالیاں کھل جائیں۔`;
    conversationHistory.push({ role: "assistant", content: reply });
    return reply;
  }

  // 6. Fever & Temperature / بخار، تپ، جسم گرم
  if (q.includes("بخار") || q.includes("حرارت") || q.includes("جسم گرم") || q.includes("تپ") || q.includes("سست")) {
    const reply = `**🌡️ گھوڑے کا تیز بخار اور سستی: ہنگامی طبی پروٹوکول**
*(غیاث فارم ہاؤس ایمرجنسی گائیڈ)*

گھوڑے کا عام جسمانی درجہ حرارت 99.5°F تا 101.5°F ہوتا ہے۔ 102°F سے اوپر بخار شمار ہوتا ہے۔

---

### **🧊 1. فوری اقدامات:**
• سر، گردن اور چاروں ٹانگوں پر نلکے کے تازہ پانی کی دھار ڈالیں یا گیلے تولیے رکھیں۔ (پیٹ اور پشت پر برف ہرگز نہ ڈالیں)۔
• گھوڑے کو فوری سایہ دار اور کھلی ہوا میں باندھیں۔

---

### **💊 2. ویٹرنری بخار کش ادویات:**
• فوری ویٹرنری ڈاکٹر سے رابطہ کر کے اینٹی پائیریٹک انجیکشن لگوائیں:
  - **Ketoprofen (Ketofen)** 2.2 mg/kg IV، یا
  - **Flunixin Meglumine (Banamine)** 1.1 mg/kg IV۔
• پینے کے پانی میں **Electro Fuel** یا گلوکوز اور کالا نمک شامل کریں تاکہ توانائی برقرار رہے۔`;
    conversationHistory.push({ role: "assistant", content: reply });
    return reply;
  }

  // 7. Hoof Problems / کھر، نعل، کیل، سڑاند، تلوا، لیمینائٹس
  if (q.includes("کھر") || q.includes("نعل") || q.includes("کیل") || q.includes("سڑاند") || q.includes("تلوا") || q.includes("لیمینائٹس") || q.includes("فاؤنڈر") || q.includes("لنگڑ")) {
    const reply = `**🐎 کھروں کی خرابی، سڑاند (Thrush)، کیل لگنے اور لنگڑاہٹ کا دیسی و ویٹ علاج**
*(غیاث فارم ہاؤس ہوف کیئر پورٹل)*

"گھوڑے کا کھر نہیں تو گھوڑا نہیں" — کھر کے مسائل کا فوری علاج درج ذیل ہے:

---

### **🌿 1. کھر کی سڑاند اور بدبو (Thrush):**
• کھر کے تلوے کو کھرکھرے اور برش سے دھو کر خشک کریں۔
• **نیلا تھوتھا (10g) + کافور (15g) + تارا میرا کا تیل (200ml)** ملا کر تلوے اور لکیروں پر لگائیں۔ بدبو اور گند 48 گھنٹے میں ختم ہو جائے گی۔

---

### **🧲 2. کیل لگنا یا کھر کا پھوڑا (Abscess / Pricked Foot):**
• نیم گرم پانی میں 1 مٹھی **ایپسوم سالٹ (Epsom Salt)** ڈال کر کھر کو 20 منٹ بھگوئیں تاکہ پیپ نرم ہو کر نکل جائے۔
• اوپر پائیوڈین کا کاٹن پیڈ رکھ کر پٹی باندھیں اور ٹیٹنس ٹاکسوائیڈ کا ٹیکہ لازمی لگائیں۔

---

### **🚨 3. لیمینائٹس (Founder) کی ہنگامی تنبیہ:**
• اگر دونوں اگلے کھر سخت گرم ہوں، گھوڑا پچھلے پاؤں پر بیٹھ رہا ہو اور نبض تیز ہو تو یہ لیمینائٹس ہے۔ اس کا فوری علاج 48 گھنٹے تک کھروں کو برف کے تھیلوں میں رکھنا (Ice Boots) ہے۔`;
    conversationHistory.push({ role: "assistant", content: reply });
    return reply;
  }

  // 8. Wounds & Bleeding / زخم، کٹ، خون کا بہنا، پیپ
  if (q.includes("زخم") || q.includes("کٹ") || q.includes("خون") || q.includes("پیپ") || q.includes("پھوڑا") || q.includes("ناسور") || q.includes("ٹٹنس")) {
    const reply = `**🩹 گھوڑے کے گہرے زخم، خون بہنے اور پیپ کا فوری فرسٹ ایڈ علاج**
*(غیاث فارم ہاؤس نیزہ بازی فیلڈ کیئر)*

---

### **🩸 1. خون کا بہنا روکنا:**
• صاف جراثیم کش کپڑا یا تولیہ زخم پر رکھ کر دونوں ہاتھوں سے 10 منٹ تک مضبوط دباؤ (Direct Pressure) ڈالیں۔
• اگر خون فوارے کی طرح اچھل رہا ہو تو فوری ویٹرنری ڈاکٹر سے رگ کو کلیمپ یا ٹانکے لگوائیں۔

---

### **🌿 2. دیسی اینٹی سیپٹک مرحم:**
• بھونی ہوئی سفید پھٹکری (20 گرام) + کافور (10 گرام) + نیم کا تیل یا تارا میرا کا تیل (100ml) ملا کر مرحم بنائیں۔
• زخم کو پائیوڈین (Pyodine) سے دھو کر اوپر مرحم لگائیں۔ یہ مکھیوں کو بھی بیٹھنے نہیں دیتا اور گندے گوشت (Proud flesh) کو ختم کرتا ہے۔
• **⚠️ اہم:** چوٹ لگنے پر 24 گھنٹے کے اندر **Tetanus Antitoxin (TAT 1500-3000 IU)** لازمی لگوائیں۔`;
    conversationHistory.push({ role: "assistant", content: reply });
    return reply;
  }

  // 9. Heat Stroke / گرمی، لُو، پسینہ، پانی کی کمی
  if (q.includes("گرمی") || q.includes("لُو") || q.includes("پسینہ") || q.includes("پانی کی کمی") || q.includes("ڈی ہائیڈریشن") || q.includes("پیاس")) {
    const reply = `**☀️ گھوڑے کو شدید گرمی، لُو لگنا اور پانی کی کمی کا دیسی شربت و علاج**
*(غیاث فارم ہاؤس ہائیڈریشن پروٹوکول)*

---

### **🥤 1. شاہی دیسی ہائیڈریشن شربت:**
• **صاف تازہ پانی:** 5 لیٹر
• **پرانا دیسی گڑ:** 100 گرام
• **پسا کالا نمک:** 10 گرام + **لاہوری نمک:** 10 گرام
• **تخم ملنگا (بھگویا ہوا):** 20 گرام
• **سونف کا عرق یا جوشاندہ:** آدھا کپ
• اچھی طرح گھول کر دوڑ یا گرمی کے بعد گھوڑے کے نارمل ہونے پر پلائیں۔ گھوڑے کی تھکن فوراً دور ہوتی ہے۔

---

### **🚨 2. انتہائی ضروری احتیاط:**
• سخت گرمی یا پسینے میں لت پت گھوڑے کو **کبھی بھی برف کا ٹھنڈا پانی نہ پلائیں**، ورنہ معدے کی شریانیں سکڑ کر جان لیوا قولنج یا لیمینائٹس ہو سکتا ہے۔ ہمیشہ 30 منٹ واک کے بعد تازہ نیم گرم پانی دیں۔`;
    conversationHistory.push({ role: "assistant", content: reply });
    return reply;
  }

  // 10. Kitchen Herbs & Spices (کچن اشیاء و مصالحہ جات)
...
• **تارا میرا کا تیل:** کھروں کی مالش، خشکی ختم کرنے، جوئیں اور جلد کی خارش، فنگس اور الرجی کا اکسیر خاتمہ۔
...
• **نیلا تھوتھا (Copper Sulfate):** 5 تا 10 گرام پانی یا تارا میرا کے تیل میں حل کر کے کھر کی شدید سڑاند (Thrush) پر لگانے کے لیے۔`;
  ...
  // 11. Clinical Veterinary Questions (Dr. Osama Vet & Dr. Sultan Masood)
...
• اسپِ شفا اے آئی ڈاکٹر کے پاس ان تمام ماہر ڈاکٹرز کے کلینیکل کیسز اور رہنما اصول محفوظ ہیں۔ آپ کسی بھی مسئلے پر مزید رہنمائی لے سکتے ہیں۔`;
  ...
  // 12. Smart Comprehensive Holistic Equine Advisor (Default Fallback)
  const generalReply = `**السلام علیکم و رحمتہ اللہ!**
**اسپِ شفا اے آئی ویٹرنری کلینیکل پورٹل (غیاث فارم ہاؤس - فہیم غیاث محمود)**

آپ کے سوال کے حوالے سے میں نے کلینیکل ڈیٹا بیس چیک کر لیا ہے۔ گھوڑے کی درست تشخیص کے لیے درج ذیل معلومات انتہائی اہم ہیں:

---

### **🩺 1. گھوڑے کے بنیادی وائٹل سائنز (Normal Vital Signs):**
• **نبض (Heart Rate):** 28 تا 44 دھڑکن فی منٹ (جبڑے کے نیچے شریان چیک کریں)۔
• **سانس کی رفتار:** 8 تا 16 سانس فی منٹ (پسلیوں کی حرکت)۔
• **جسمانی درجہ حرارت:** 99.5°F تا 101.5°F (معدے یا پیٹ سے ریکٹل تھرمامیٹر)۔
• **مسوڑھوں کی رنگت:** ہلکا گلابی (دبانے پر 2 سیکنڈ میں رنگ واپس آئے)۔

---

### **🔍 2. اپنے مسئلے کے مطابق براہِ راست رہنمائی حاصل کریں:**
آپ مائیک پر بول کر یا لکھ کر ان میں سے کوئی بھی سوال پوچھ سکتے ہیں:
• **"خارش کا علاج"** — چمڑی کی خارش، جوئیں، فنگس اور تارا میرا تیل کا نسخہ۔
• **"موٹا کرنے کا نسخہ"** — کمزور گھوڑے کا شاہی راشن و ڈیورمنگ۔
• **"پیٹ درد کا کاڑھا"** — قولنج، گیس اور اپھارے کا فوری علاج۔
• **"پٹھوں کا لیپ"** — کھچاؤ، موچ، سوجن اور نیزہ بازی کی تھکن۔
• **"کھانسی اور بلغم"** — گڑ، کالی مرچ اور سنڈھ کا حلوہ۔
• **"کھر کی سڑاند و کیل"** — کھروں کا تیل، ایپسوم سالٹ اور ہوف کیئر۔
• یا گھوڑے کی متاثرہ جگہ کی **📷 تصویر / 🎥 ویڈیو فریم** منسلک کریں تاکہ لائیو معائنہ کیا جا سکے!`;
...
function initVoiceRecognition() {
  ...
  if (SpeechRecognition) {
    try {
      ...
      recognition.onstart = () => {
        activeVoiceEngine = 'speech-api';
        setRecordingUI(true, "🔴 لائیو آواز ریکارڈ ہو رہی ہے... بولیں (English / اردو / پنجابی)");
      };
      ...
      recognition.onerror = (event) => {
        ...
        if (event.error === "not-allowed" || event.error === "service-not-allowed") {
          ...
          console.log("Web Speech issue (" + event.error + "), falling back to MediaRecorder/Whisper...");
          try {
            recognition.abort();
          } catch(e) {}
          startMediaRecorder();
      ...
      recognition.onend = () => {
        if (activeVoiceEngine === 'speech-api') {
          if (isRecording && !hasSubmittedThisSession && chatInput && chatInput.value.trim()) {
            setTimeout(() => {
      ...
      console.warn("Web Speech API setup failed", e);
      recognition = null;
    }
  }

  // --- Engine 2: MediaRecorder + Groq Whisper ---
  async function startMediaRecorder() {
    ...
    try {
      ...
      voiceAudioChunks = [];
      hasSubmittedThisSession = false;
      activeVoiceEngine = 'media-recorder';

      const mimeTypes = ['audio/webm;codecs=opus', 'audio/webm', 'audio/ogg;codecs=opus', 'audio/mp4', ''];
      const supportedMime = mimeTypes.find(type => !type || MediaRecorder.isTypeSupported(type)) || '';
      voiceMediaRecorder = supportedMime ? new MediaRecorder(voiceStream, { mimeType: supportedMime }) : new MediaRecorder(voiceStream);
  ...
  function startRecording() {
    if (recognition) {
      try {
        ...
        console.warn("Could not start Web Speech, using MediaRecorder", e);
      }
    }
    startMediaRecorder();
  }
  ...
  function stopRecording(shouldSubmit = true) {
    ...
    if (activeVoiceEngine === 'speech-api' && recognition) {
      try {
        recognition.stop();
      } catch (e) {}
      if (shouldSubmit) {
        setTimeout(() => submitCurrentVoiceQuery(), 150);
      } else {
        setRecordingUI(false);
      }
    } else if (activeVoiceEngine === 'media-recorder' && voiceMediaRecorder) {
  ...
  function cancelRecording() {
    ...
    setRecordingUI(false);
    if (chatInput && (chatInput.value.startsWith("⏳") || chatInput.value.startsWith("🔴"))) {
      chatInput.value = "";
    }
  }
...
async function transcribeAudioWithWhisper(audioBlob) {
  ...
  formData.append("prompt", "اسپِ شفا، گھوڑے کا دیسی علاج، نیزہ بازی، خوراک، ونڈا، پٹھے، کھر، بیماری، چھولے، دلیہ، لتاں، سوجن");
